...
//	}
	 ...
	 * @return UrlMapper
	 */
	static function url(bool $mandatory = false, ?array $allowedSchemas = null, bool $schemeRequired = true): UrlMapper {
		return new UrlMapper($mandatory, $allowedSchemas, $schemeRequired);
	}
